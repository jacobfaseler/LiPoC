...
const PWMTimerMSP432_HWAttrsV2 pwmTimerMSP432HWAttrs[CONFIG_PWM_COUNT] = {
    ...
    {
        .clockSource = TIMER_A_CLOCKSOURCE_SMCLK,
        .pwmPin = PWMTimerMSP432_P2_2_TA1CCR2A, /* P2_2 */
    },
    /* CONFIG_PWM_DC */
    {
        .clockSource = TIMER_A_CLOCKSOURCE_SMCLK,
        .pwmPin = PWMTimerMSP432_P2_5_TA1CCR1A, /* P2_5 */
    },
};
...
const PWM_Config PWM_config[CONFIG_PWM_COUNT] = {
    ...
    {
        .fxnTablePtr = &PWMTimerMSP432_fxnTable,
        .object = &pwmTimerMSP432Objects[CONFIG_PWM_DC],
        .hwAttrs = &pwmTimerMSP432HWAttrs[CONFIG_PWM_DC]
    },
};
...
const Timer_Config Timer_config[CONFIG_TIMER_COUNT] = {
    ...
    /* CONFIG_TIMER2 */
    {
        ...
        .object      = &timerMSP432Objects[CONFIG_TIMER2],
        .hwAttrs     = &TimerMSP432HWAttrs[CONFIG_TIMER2]
    },
    /* CONFIG_TIMER3 */
    {
        .fxnTablePtr = &TimerMSP432_Timer_A_fxnTable,
